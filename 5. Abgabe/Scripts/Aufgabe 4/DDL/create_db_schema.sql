...
FK_Orte_Flughafen erst spater erstellt*/    
CREATE TABLE Orte
    (OrtsID INTEGER
...
circulaeren Dependenz zwischen den Relationen Orte, Adressen, Flughaefen erst nach der vollst√§ndigen
...
/* Es ist nur eine Umwandlung von unverbindlichen Reservierungen zu verbindlichen Buchungen mˆglich  */
/* Die Belegungen einer Ferienwohnung d¸rfen sich nicht zeitlich ¸berschneiden */


/*Eine Belegung f¸hrt nach einer Woche zu einer Rechnung */
